...
token = AutoTokenizer.from_pretrained("hfl/chinese-roberta-wwm-ext-large")
...
def collate_fn(data):
    ...
    for i in data:
        ...
        # 恶心死我了
        if len(text_one) > 1022:
            text_one = text_one[:1022]
    ...
    try:
        for epoch in range(num_epochs):
            ...
            if val_f1 > best_val_f1:
                ...
                torch.save(model.state_dict(), "best_5.pt")
                counter = 0
            else:
                counter += 1
